...
function registerTestOracle (account) {
...
// describe.skip(`B1. [FIO] Oracles (register)`, function () {
...
// describe.skip(`C1. [FIO] Oracles (unregister)`, function () {
...
// describe.skip(`D1. [FIO] Oracles (setoraclefees)`, function () {
//
...
//     }
//   });
//   // it.skip(`(api)(empty wrap_fio_domain) try to set oracle fees, expect Error`, async function () {
...
//   // });
//
//   it.skip(`(empty wrap_fio_tokens) try to set oracle fees, expect "" to be cast to 0`, async function () {
//     try {
//       const result = await newOracle.sdk.genericAction('pushTransaction', {
//         action: 'setoraclefee',
//         account: 'fio.oracle',
...
//   // });
//
//   it.skip(`(empty actor) try to set oracle fees, expect SDK to inject default actor value`, async function () {
//     try {
//       const result = await newOracle.sdk.genericAction('pushTransaction', {
//         action: 'setoraclefee',
//         account: 'fio.oracle',
...
// describe.skip(`F1. [FIO] Wrap FIO tokens`, function () {
//
...
//     }
//   });
//   it.skip(`(api)(negative max_oracle_fee) try to wrap 1000 FIO tokens, expect max_oracle_fee to cast to unsigned integer`, async function () {
...
// describe.skip(`G1. [FIO] Unwrap FIO tokens`, function () {
//
//   let wrapAmt = 1000000000000;
...
// describe.skip(`I1. [FIO] Wrap FIO domains`, function () {
//
//   let wrapAmt = 1000000000000;
//   let oracle1, oracle2, oracle3, user1, newOracle, newOracle1, newOracle2, custodians, factory, wfio;
//
