...
describe('************************** fee-voting-fee-setting.js ************************** \n A. Vote fees for top prods.', () => {
 ...
 // manage votes, look at the top 42...
  ...
  it(`Create 5 users, set as backup producers, fee vote them`, async () => {
    try {
      userA1 = await newUser(faucet);
     // console.log("A1.account", userA1.account)
...
/*
  ...
  it(`Create 6 users, set as backup producers, fee vote them`, async () => {
    try {
     // console.log("A1.account", userA1.account)
      userA1 = await newUser(faucet);
      process.stdout.write("           Create and Vote for backup prods . ")
