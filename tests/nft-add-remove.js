...
describe.skip(`H. (api) Try to add and remove some new NFTs`, () => {
  let user1, user2, user3;
  ...
  it(`Add NFT to user1 FIO Address`, async () => {
    try {
      const result = await callFioApi('push_transaction', {
        action: 'addnft',
        account: 'fio.address',
        actor: user1.account,
        privKey: user1.privKey,
        data: {
          "fio_address": user1.address,
          "nfts": [{
            "chain_code":"ETH","contract_address":"0x123456789ABCDEF", "token_id":"1", "url":"", "hash":"","metadata":""
...
describe.skip(`I. (api) Try to modify existing NFTs`, () => {});

describe.skip(`J. (api)(unhappy) Try to remove more NFTs than minted`, () => {
  let user1, user2, user3;
...
describe.skip(`K. (api)(unhappy) Try to remove NFTs with invalid user input`, () => {
  let user1, user2, user3;
...
describe.skip(`L. (api)(unhappy) Try to remove an NFT belonging to another user`, () => {
  let user1, user2, user3;
...
describe(`M. (api) Confirm that get_nfts_fio_address returns NFTs`, () => {
  let user1, user2, user3;
...
describe(`N. (api) Confirm that get_nfts_contract returns NFTs at a specific contract address`, () => {
  let user1, user2, user3;
  let feeAmt = 100000000;
  let user1Hash, user2Hash;
...
describe(`O. (api) Confirm that get_nfts_hash returns NFTs with a specific hash`, () => {
  let user1, user2, user3;
  // let feeAmt = 100000000;
...
describe.skip(`P. Test NFT uniqueness requirements`, () => {
